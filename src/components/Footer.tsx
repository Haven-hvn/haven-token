...
const NAVIGATION = {
  QUICK_LINKS: ["Documentation", "Technology", "Use Cases", "How It Works"],
  RESOURCES: ["API Docs", "FAQs", "Community", "Blog"],
} as const;
...
const SOCIAL_LINKS = [
  ...
  {
    name: "Join Telegram",
    href: "https://t.me/sinboxcommunity",
  ...
  {
    name: "Visit LinkedIn",
    href: "https://www.linkedin.com/company/sinbox",
